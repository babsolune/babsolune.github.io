jQuery(function(){
	...
	jQuery.get('scan.php', function(data) {
        ...
        dataList.on('click', '.modal', function(e) {
            ...
            if (data == 'code-file') {
                jQuery('<iframe/>', {src : hrefValue}).appendTo('#file-viewer');
            }
		...
		function render(data) {
			...
			if(scannedFiles.length) {
				...
				scannedFiles.forEach(function(f) {
                    ...
                    var codeFiles = ['css', 'scss', 'saas', 'html', 'tpl', 'js', 'jsx', 'xml', 'xhtml', 'txt', 'md'];
                        ...
                        '<li class="files ' + fileStyle + '" ' + isPicture + '>'
                            + '<div class="file-infos">'
                                ...
                                + '<div class="file-between">'
                                    ...
                                    + '<a href="' + window.location.href + f.path + '" aria-label="copy link" class="copy-link-to-clipboard"><i class="fa fa-lg fa-clipboard" aria-hidden="true"></i></a>'
                                    + viewLink
                                + '</div>'
                            + '</div>'
                        + '</li>');
